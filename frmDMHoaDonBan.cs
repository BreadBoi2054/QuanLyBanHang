...
{
    public partial class frmDMHoaDonBan : Form
    {
        DataTable tblCTHDB; //Bảng chi tiết hoá đơn bán
        public frmDMHoaDonBan()
        {
            InitializeComponent();
        }
        ...
        private void frmDMHoaDonBan_Load(object sender, EventArgs e)
        {
            ...
            txtGiamGia.Text = "0";
            txtTongTien.Text = "0";
            Functions.FillComboBox(cboMaKhach, "SELECT MaKhach, TenKhach FROM tblKhach", "MaKhach", "MaKhach");
            cboMaKhach.SelectedIndex = -1;
            Functions.FillComboBox(cboMaNhanVien, "SELECT MaNhanVien, TenNhanVien FROM tblNhanVien", "MaNhanVien", "TenKhach");
            cboMaNhanVien.SelectedIndex = -1;
            Functions.FillComboBox(cboMaHang, "SELECT MaHang, TenHang FROM tblHang", "MaHang", "MaHang");
        ...
        private void LoadDataGridView()
        {
            ...
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien " +
                    "FROM tblChiTietHDBan AS a, tblHang AS b " +
                    "WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' " +
        ...
        {
            Functions.FillComboBox(cboMaHD, "SELECT MaHDBan FROM tblHDBan", "MaHDBan", "MaHDBan");
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Cửa hàng";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Xuân La - Tây Hồ - Hà Nội";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: 0961391320";
        ...
        private void frmDMHoaDonBan_FormClosing(object sender, FormClosingEventArgs e)
        {
